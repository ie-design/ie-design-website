...
export const addRemixBlog = addBlog("07-remix", (b: BlogContext) => {
    b.addImage("telly-tape.jpg");
    b.addSpace();
    ...
    b.addSpace();
    b.addParagraph("Lee Lipscomb is i.e. design’s Senior Designer. The cassette tape featured is a recording of a 1973 Telly Savalas album called “Telly.”  It includes his stunning cover of the song “If.” You can enjoy it on video here.");
});
