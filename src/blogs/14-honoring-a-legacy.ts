...
export const honoringALegacy = new Blog(
    ...
    (b: Blog) => {
        ...
        b.addParagraph(
            ...
            ", whose images, shot on an editorial assignment shortly before Diana’s passing, were warm, natural, and alive. We reached out, and Penny was generous with both her time and her archive. She had spent days with Diana at her home in the central Mex- ico village of Zitácuaro: photographing her in the kitchen, moving through local markets, greeting neighbors and friends. Many of those images had never been published. They were exactly what the site needed."
        );
