import { animateSpringToTarget, Spring } from "../animation";
...
export function addWorkPage() {
    ...
    const fromLeft = () => (isLandscape() ? innerHeight * 0.45 : innerWidth * 0.08);
    const fromRight = () => (isLandscape() ? innerHeight * 0.45 : innerWidth * 0.08);
